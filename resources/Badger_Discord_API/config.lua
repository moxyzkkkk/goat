Config = {
	Guild_ID = '1246428481051689041', -- Set to the ID of your guild (or your Primary guild if using Multiguild)
	Multiguild = false, -- Set to true if you want to use multiple guilds
	Guilds = {
		["name"] = "guild_id", -- Replace this with a name, like "main"
	},
	Bot_Token = 'MTI0MjI4NDg2NDIyOTYwOTUwMw.GaCJL8.JzPL1pkV0p5MCwvk1saYfGzN4a_9GWQfSBmAaA',
	RoleList = {},
	DebugScript = false,
